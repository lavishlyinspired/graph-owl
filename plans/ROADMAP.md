...
| ~~Hosting large external ontologies at 10⁸–10⁹ triples~~ | **Adopted 28 Jul 2026 — no longer a refusal.** `00a-product-position.md` takes the engine framing the architecture already had. Delivered in three phases; Epic 100 (profile detection) ships in **Phase 1** as the guard that makes RL-only honest, not in Phase 2 with the reasoners it routes to | Already adopted |
