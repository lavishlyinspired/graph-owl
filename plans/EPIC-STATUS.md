...
| **14** | 5 | [`14-mcp-activation.md`](14-mcp-activation.md) | **Shipped** | 9/9 | Epic 7a (subgraph retrieval for agent context), Epic 13 (authorization — **hard… |
...
| **21** | 6 | [`21-document-ingestion.md`](21-document-ingestion.md) | **Shipped** | 5/5 | Epic 16 (ingestion), Epic 17 (mention resolution) |
...
| **26** | 7 | [`26-lifecycle-certification.md`](26-lifecycle-certification.md) | **Shipped** | 10/10 | Epic 11 (issuers are principals), Epic 24 (metrics are certifiable) |
...
| **31** | 5 | [`31-memory.md`](31-memory.md) | **Shipped** | 3/3 | Epic 3 (envelope), Epic 11 (people), Epic 14 (MCP surface to serve it) |
...
| **42** | 7 | [`42-ui-semantic-surfaces.md`](42-ui-semantic-surfaces.md) | In progress | 4/5 (+1 partial) | Epic 39 (shell, patterns, trust components), Epic 41 (admin section, schema-dri… |
...
| **94** | 10 | [`94-rdf12-alignment.md`](94-rdf12-alignment.md) | **Shipped** | 8/8 | Epic 4 (flakes, reified relationships), Epic 9 (serialization) |
...
| **97** | 10, 12 | [`97-incremental-parallel-reasoning.md`](97-incremental-parallel-reasoning.md) | **Shipped** | 5/5 | Epic 6 (semi-naive fixpoint), Epic 37a (the measurement) |
| **98** | 11, 12 | [`98-owl-el-reasoning.md`](98-owl-el-reasoning.md) | **Shipped** | 4/4 | Epic 6 (overlay, budgets, explainability), Epic 24 (ontologies as entities) |
...
| **105** | — | [`105b-native-reconcile-engine.md`](105b-native-reconcile-engine.md) | In progress | 0/1 (+1 partial) | Epic 105 DN-1/DN-2/DN-3 (shipped), P0/P0b (shipped), the findings storage+queue… |
...
- [x] Outbound webhooks, HMAC-signed, at-least-once *(Slice F)*
- [x] The thesis test: an agent with only MCP access answers a real question *(Slice G)* — aga
- [x] Stdio transport, and the `rust-mcp-schema` → `rmcp` swap
...
- [x] OvisOCR2 vision-model parser — the deferred OCR adapter, built
...
- [x] One review queue over five proposal sources — **Slices C–D shipped, 7 August 2026, propo
...
- [x] Export dialog — format, scope, as-of, preview before download — **Slice E's own gap, shi
...
- [x] C (console) — canvas-rendered graph-node captions, closed 9 August 2026.
...
- [x] Export dialog offers RDF as one of its format choices and previews it *(UI → Epic 42)* —
...
- [x] Decision 4.4 implemented: server-tracked retraction watermark, no caller involvement — s
- [x] Overlay staleness is visible — shipped 8 August 2026 (Phase 3 item 3.11).
- [x] Console: overlay staleness actually shown, not just on the wire — shipped 9 August 2026 
...
- [x] No UI of their own — by design, verified 8 August 2026.
...
- [x] No UI — by design, verified 8 August 2026.
...
### Epic 105 — Native reconcile engine — the platform plan's P5, actually in Rust
