...
| **42** | 7 | [`42-ui-semantic-surfaces.md`](42-ui-semantic-surfaces.md) | In progress | 0/3 (+1 partial) | Epic 39 (shell, patterns, trust components), Epic 41 (admin section, schema-dri… |
...
- [~] One vocabulary browser over glossary, tags, domains, packs — **Slice A shipped, 7 August
