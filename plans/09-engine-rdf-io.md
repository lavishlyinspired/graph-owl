...
5. **JSON-LD context is versioned and served.** The same JSON expands to different RDF under different contexts; the context must be a stable, fetchable artifact or round-trips are unreproducible.
