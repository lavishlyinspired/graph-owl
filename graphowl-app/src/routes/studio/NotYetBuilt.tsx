...
export function NotYetBuilt({ body }: { readonly body: string }) {
  return (
    <div className="max-w-[560px] rounded-lg border border-gowl-line bg-gowl-panel p-5">
      <div className="mb-2 font-mono text-[13.5px] tracking-widest text-gowl-t6">{strings.studioNotYetBuiltTitle}</div>
      <p className="text-[16.5px] leading-relaxed text-gowl-t3">{body}</p>
    </div>
  );
}
