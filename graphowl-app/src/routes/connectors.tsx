...
export default function ConnectorsRoute() {
  ...
  return (
    <div className="p-8">
      <h1 className="mb-1 text-[21px] font-semibold text-gowl-t1">{strings.connectorsTitle}</h1>
      <p className="mb-5 text-[12.5px] text-gowl-t5">{strings.connectorsDescription}</p>

      <div className="max-w-[520px] rounded-lg border border-gowl-line bg-gowl-panel p-5">
        <div className="mb-4">
          <div className="text-[14px] font-semibold text-gowl-t1">{strings.connectorsPostgresName}</div>
          <div className="text-[12px] text-gowl-t5">{strings.connectorsPostgresDescription}</div>
        </div>
        ...
        <div className="mb-3 grid grid-cols-2 gap-2">
          ...
          <input
            ...
            className="col-span-2 rounded-md border border-gowl-line-2 bg-gowl-input px-2 py-1.5 text-[12px] text-gowl-t1"
          />
        </div>
        ...
        <button
          ...
          onClick={runTest}
          className="mb-2 rounded-md border border-gowl-line-2 px-3 py-1.5 text-[12px] text-gowl-t2 disabled:opacity-40"
        >
          {strings.connectorsTestSubmit}
        </button>
        {testResult && (
          <p className={`mb-3 text-[12px] ${testResult.ok ? "text-gowl-ok" : "text-gowl-bad"}`}>
            {testResult.ok ? strings.connectorsTestOk : testResult.detail}
          </p>
        )}

        <div className="mt-3 border-t border-gowl-line-2 pt-3">
          <div className="mb-2 font-mono text-[9.5px] tracking-widest text-gowl-t6">{strings.connectorsRunTitle}</div>
          <input
            value={serviceName}
          ...
          {runResult && (
            <div className="mt-3 rounded-md border border-gowl-line-2 bg-gowl-panel-2 p-3 font-mono text-[11.5px] text-gowl-t2">
              <div className="mb-1 font-mono text-[9.5px] tracking-widest text-gowl-t6">{strings.connectorsRunResult}</div>
